...
SanctiSpíritus.addEventListener('click', () => {
    ...
    FetchData();
    SanctiSpíritus.style.fill = '#e40ab5';
});
...
SantiagodeKubo.addEventListener('click', () => {
    ...
    FetchData();
    SantiagodeKubo.style.fill = '#e40ab5';
});
